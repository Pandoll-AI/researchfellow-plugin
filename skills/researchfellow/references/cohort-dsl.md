...
```bash
# From file
python3 ${CLAUDE_PLUGIN_ROOT}/skills/researchfellow/scripts/dsl_compiler.py --dsl cohort.dsl --output extraction.sql

# With schema validation
python3 ${CLAUDE_PLUGIN_ROOT}/skills/researchfellow/scripts/dsl_compiler.py --dsl cohort.dsl --schema schema.json --output extraction.sql

# From stdin
echo "INCLUDE: age >= 18
INDEX: cohort_start
FOLLOWUP: outcome_or_censor" | python3 ${CLAUDE_PLUGIN_ROOT}/skills/researchfellow/scripts/dsl_compiler.py --stdin --output extraction.sql
```
