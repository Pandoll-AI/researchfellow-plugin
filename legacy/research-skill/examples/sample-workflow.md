...
This example demonstrates the full 12-step RRA workflow.
...
```bash
python3 analysis_runner.py --mode real --project-dir .research/ --data-path extracted_cohort.csv --sap-version v0.1
```
